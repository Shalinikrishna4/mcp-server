...
TOKEN = "13e1e4a244d9"
MY_NUMBER = "919092209325"  # Insert your number {91}{Your number}
...
async def resume() -> str:
    resume_path = Path(r"D:\puch-mcp-server\resume.txt")
...
# <-- Add this about tool here:
@mcp.tool
async def about() -> dict:
    return {
        "name": "My MCP Server",
        "description": "MCP server serving resume and fetch tools for Puch AI."
    }
